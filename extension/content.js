...
// ========== OPTIONAL: VIDEO EVENT LISTENERS ==========

/**
 * You can uncomment this section to automatically notify
 * the sidebar when video events occur (play, pause, seek).
 * This would enable more reactive timestamp updates.
 */
...
if (document.readyState === 'complete') {
  ...
  window.addEventListener('load', setupVideoListeners);
}
*/
